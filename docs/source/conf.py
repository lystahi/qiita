...
# get_started_pyspark documentation build
...
from get_started_pyspark import __version__ as release

# -- Project information -----------------------------------------------------

project = "get_started_pyspark"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "get_started_pysparkdoc"
...
latex_documents = [
    (
        master_doc,
        "get_started_pyspark.tex",
        "get_started_pyspark Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "get_started_pyspark",
        "Project get_started_pyspark codebase.",
        "Data-Science",
    )
]
